...
import { Drawer, DrawerFooter, FormField, Input, Select, Textarea, Button, Icon } from '../../design-system/components';
...
export function FamilyMemberDrawer({ member, onSave, onClose, isOpen }: FamilyMemberDrawerProps) {
  ...
  return (
    ...
    >
      <form id="family-member-form" onSubmit={handleSubmit} className="space-y-6">
        {/* Campos Essenciais */}
            ...
            >
              <div className="flex items-center gap-2">
                <Input
                  ...
                  min={0}
                  max={100}
                  className={errors.benefit_share_percentage ? 'border-red-300 focus:ring-red-500 flex-1' : 'flex-1'}
                />
